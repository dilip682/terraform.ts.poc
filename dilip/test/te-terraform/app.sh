...
# Install Tomcat
yum install tomcat80-webapps -y
cd $lib_dir
wget https://s3.ap-south-1.amazonaws.com/terraform-software/trade_engine_libraries/activation.jar
wget https://s3.ap-south-1.amazonaws.com/terraform-software/trade_engine_libraries/mail.jar
